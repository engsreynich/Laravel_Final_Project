      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
         ...
         <div class="carousel-inner">
            ...
            <div class="carousel-item">
               <div class="row">
                  <div class="col-sm-12">
                     <h1 class="banner_taital">Learn Dance</h1>
                     <div class="contact_bt"><a href="{{ url('contact.html') }}">Read More</a></div>
                  </div>
               </div>
            </div>
            <div class="carousel-item">
               <div class="row">
                  <div class="col-sm-12">
                     <h1 class="banner_taital">Join Us</h1>
                     <div class="contact_bt"><a href="{{ url('contact.html') }}">Read More</a></div>
                  </div>
               </div>
            </div>
            <div class="carousel-item">
               <div class="row">
                  <div class="col-sm-12">
                     <h1 class="banner_taital">Get Inspired</h1>
                     <div class="contact_bt"><a href="{{ url('contact.html') }}">Read More</a></div>
                  </div>
               </div>
            </div>
   ...
   <div class="container">
      ...
      <div class="service_section_2 layout_padding">
         <div class="owl-carousel owl-theme">
            <div class="item">
               <div class="image_box">
                  <img src="{{ asset('./P/Profusion-1.0.0/images/img-1.png') }}" alt="Rock Dance" />
               </div>
            ...
            <div class="item">
               <div class="image_box">
                  <img src="{{ asset('./P/Profusion-1.0.0/images/img-2.png') }}" alt="Hip Hop Dance" />
               </div>
            ...
            <div class="item">
               <div class="image_box">
                  <img src="{{ asset('./P/Profusion-1.0.0/images/img-1.png') }}" alt="Style Dance" />
               </div>
